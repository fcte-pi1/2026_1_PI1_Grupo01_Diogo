...
\begin{description}
    \item [Nome do Projeto:] Micromouse Autônomo
...
\section{Indicadores}
\textcolor{black}{Alguns dos indicadores que determinam o mercado consumidor e o potencial de aplicação do \textbf{Micromouse} são:}
\begin{enumerate}

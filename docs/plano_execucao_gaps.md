...
vivo + salvamento com encerramento **automático**). Este plano lista o que falta
para o E2E ficar **completo e correto** com a navegação real, em ordem de execução.
...
3. **G3** (não finalizar cedo) → 4. **G4** (bateria real) → 5. **G5** (minimapa correto)
